		  ...
		  <c:if test="${(isFullView != 'Y')}">	
			...
			<c:if test="${(isFullView == 'Y')}">
			  	...
			  	<div class="tab-content">
					...
					<%@ include file="Neighbourhood.jsp" %>					
					<%@ include file="Comparable.jsp" %>										
			...
			<c:if test="${(isFullView != 'Y')}">
				...
				<div class="tab-content">
					...
					<div id="neighbourhood_tab" class="tab-pane fade">
						<%@ include file="Neighbourhood.jsp" %>
					</div>		
								
					<div id="comparable_tab" class="tab-pane fade">
						<%@ include file="Comparable.jsp" %>
					</div>
					
					<div id="definition_tab" class="tab-pane fade">	
						<%@ include file="Definition.jsp" %>
					</div>
					...
					<div id="photo_tab" class="tab-pane fade" ng-form="photosForm" 
						ng-init="
							MainController.imagesModel = {};
							MainController.imagesDescribeModel = {x:'x'};
						">
						<!-- <span>MainController.imagesModel = <pre>{{MainController.imagesModel | json}}</pre></span>
						<span>MainController.imagesDescribeModel = <pre>{{MainController.imagesDescribeModel | json}}</pre></span><br> -->
						<%@ include file="PhotoSubject.jsp" %>
						<%@ include file="Photo.jsp" %>		    	
					</div>
					...
					<div id="addendum_tab" class="tab-pane fade">	
						<%@ include file="Addendum.jsp" %>					
					</div>	
